...
const socialLinks = [
    { icon: Github, href: "https://github.com/Aizkhan1122", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/aziz-khan12", label: "LinkedIn" },
                ...
                >
                    <div className="grid md:grid-cols-3 gap-8 md:gap-12 items-center">
                        <div className="text-center md:text-left">
                            ...
                            >
                                SYED AZIZKHAN <span className="text-primary">.</span>
                            </motion.a>
