        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12 md:mb-16 items-center">
          <ScrollReveal>
            <div className="space-y-6 text-muted-foreground leading-relaxed text-base md:text-lg">
              <p>
                Results-driven Full-Stack Software Engineer with expertise in React, Laravel, PHP, Node.js, TypeScript, MySQL, REST APIs, AWS, Docker, and CI/CD. Skilled in designing scalable architectures, building enterprise-grade applications, leading end-to-end development, and delivering secure, high-performance solutions. Focused on business impact, system reliability, code quality, and creating exceptional digital experiences.
