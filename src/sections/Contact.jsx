...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "azizkhan77277@gmail.com",
        href: "mailto:azizkhan77277@gmail.com",
        color: "#00d4ff",
    },
    {
        icon: Linkedin,
        label: "LinkedIn",
        value: "SYED AZIZKHAN",
        href: "https://www.linkedin.com/in/aziz-khan12",
        color: "#0077b5",
    },
    {
        icon: Github,
...
export const Contact = memo(() => {
    ...
    const handleSubmit = useCallback(async (e) => {
        ...
        const mailtoLink = `mailto:azizkhan77277@gmail.com?subject=Portfolio Contact: ${formData.name}&body=${encodeURIComponent(`Name: ${formData.name}\nEmail: ${formData.email}\n\nMessage:\n${formData.message}`)}`;
