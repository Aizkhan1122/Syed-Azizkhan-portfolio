...
const skills = [
    "HTML", "CSS", "Python", "JavaScript", "React", "TypeScript",
    "Tailwind CSS", "Node.js", "MySQL", "Git",
...
export const Hero = memo(() => {
    ...
    const socialLinks = useMemo(() => [
        { icon: Github, href: "https://github.com/Aizkhan1122", label: "GitHub Profile" },
        { icon: Linkedin, href: "https://linkedin.com/in/aziz-khan12", label: "LinkedIn Profile" },
                ...
                >
                    <div className="space-y-8 lg:col-span-7 xl:col-span-7">
                        ...
                        <div className="space-y-4 md:space-y-6">
                            ...
                            >
                                Full-Stack Web Developer with expertise in building scalable, high-performance web applications using modern frontend and backend technologies.efficient, and user-focused digital experiences.
                                <span className="text-foreground font-medium underline underline-offset-8 decoration-primary/30">Passionate about creating clean,</span> web applications efficient, and user-focused digital experiences.
                            </motion.p>
                        </div>
